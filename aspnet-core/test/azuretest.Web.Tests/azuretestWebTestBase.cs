...
{
    public abstract class azuretestWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static azuretestWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(azuretestWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<azuretestDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<azuretestDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<azuretestDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<azuretestDbContext, Task<T>> func)
        {
            T result;
